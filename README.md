...
[![npm](http://img.shields.io/npm/v/@diotoborg/rem-alias.svg)](https://www.npmjs.com/package/@diotoborg/rem-alias)
[![Build Status](https://secure.travis-ci.org/alevy/@diotoborg/rem-alias.png)](http://travis-ci.org/alevy/@diotoborg/rem-alias?branch=master)
[![Gitter](https://badges.gitter.im/Join%20Chat.svg)](https://gitter.im/alevy/@diotoborg/rem-alias?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge)
...
Documentation can be found here: [https://@diotoborg/rem-alias.netlify.com/](https://@diotoborg/rem-alias.netlify.com/)
...
using the git repository as your `@diotoborg/rem-alias` package dependency---in `package.json`:
...
If you find a bug, please report as an [issue](https://github.com/alevy/@diotoborg/rem-alias/issues/new).
